...
const duration = {
  seconds: function (val: number | string | BigNumber) { return BigNumber.from(val); },
  minutes: function (val: number | string | BigNumber) { return BigNumber.from(val).mul(this.seconds('60')); },
  hours: function (val: number | string | BigNumber) { return BigNumber.from(val).mul(this.minutes('60')); },
  days: function (val: number | string | BigNumber) { return BigNumber.from(val).mul(this.hours('24')); },
  weeks: function (val: number | string | BigNumber) { return BigNumber.from(val).mul(this.days('7')); },
  years: function (val: number | string | BigNumber) { return BigNumber.from(val).mul(this.days('365')); },
};
